...
<body style="background-color:#F5F5F5;">
    ...
    <div class="contaianer">
        ...
        <!-- menu login -->
        <div class="film">
            <img src="gambar/movie1.jpg" alt="">
            <img src="gambar/movie2.jpg" alt="">
            <img src="gambar/movie3.jpg" alt="">
            <img src="gambar/movie4.png" alt="">
            <img src="gambar/movie5.jpg" alt="">
        </div>
        <!-- login -->
            ...
            <div class="content">
                <div class="box-Login">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="daftar">
                            New Member, <a href="daftar.php" style="text-decoration:none; color:crimson;">Daftar Cinema tix</a>
                        </div>

                        <input type="submit" name="submit" value="Login" style="background-color: #1F3747; width:100px; height:40px;  border-radius:10px; color:aliceblue;   font-family: 'Inter';">
                    </form>
